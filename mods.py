...
import os ,sys ,math ,json ,bs4 ,datetime ,requests ,re ,socket
from random import *
from io import *
...
bot_token=input("\n\033[4;33minput the token >\033[0;m ")
owner=input("\n\033[4;33mingrese su nombre >\033[0;m ")
name=input("\n\033[4;33mingrese el nombre de su grupo >\033[0;m ")
names=input("\n\033[4;33mingrese el nombre del bot >\033[0;m ")
...
def info(update,context):
	...
	msg="""
*NAME OF THE BOT : *`flyead_hacking_bot`
...
*THANKS FOR USING MY BOT UWU*""".format(first_name,user)
	update.message.reply_text(msg,parse_mode="MarkdownV2")
